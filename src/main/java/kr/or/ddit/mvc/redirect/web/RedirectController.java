...
public class RedirectController {
	...
	public String process(Model model, HttpSession session,
		...
		//리다이렉트 된 페이지에서 일회에 한해 사용할 수 있는 속성(일회용)
		ra.addFlashAttribute("msg_ra", "hello, world_ra"); //쓸수있으니 기억해두자
		ra.addAttribute("msg_ra_attr", "brown"); //이것을 안써도 파라미터를 보낼수 있는 방법이 있을까?
