...
public class WebTestConfig {
    ...
    //					==> MemberService
	//						==> MemberRepository
	//LoginController 스프링 빈을 생성하기 위해서는 MemberService, MemberRepository 스프링 빈이 필요하다
	// 즉, service, repository 빈을 스캔하는 설정과 controller를 스캔하는 설정 두개가 필요
	
	//스프링 프레임워크의 컨트롤러 테스트 시나리오
	//1. 웹기반의 스프링 컨테이너를 구성후
	//2. dispatcherServlet역활을 하는 객체를 생성
	//3. dispatcherServlet역활을 하는 객체를 통해 url, 파라미터등을 첨부하여 요청 전송
